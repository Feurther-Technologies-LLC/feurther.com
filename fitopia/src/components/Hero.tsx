    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-white to-orange-50 py-20 md:py-24 lg:py-28">
        ...
        <div className="lg:w-1/2 mb-16 lg:mb-0 lg:pr-10 z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-xl">
              FITOPIA makes your push-up training more efficient with AI boosted visual recognition.
            </p>
            ...
            {/* 社交证明改为邮箱订阅 */}
            <div className="mt-12">
              <p className="text-gray-500 mb-3 text-sm font-medium">JOIN EMAIL LIST</p>
              <div className="max-w-md">
                <form action="email-list@feurther.com" method="POST" className="flex">
                  <input 
                    type="email" 
                    name="email" 
                    required
        ...
        >
          <div className="relative">
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl relative z-10 border-8 border-white transform translate-x-8 translate-y-8">
              ...
              {/* 播放控制UI元素 */}
              <div className="absolute bottom-4 left-4 right-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 flex items-center">
                ...
                <div className="flex-grow">
                  <div className="text-sm font-semibold text-gray-800">Workout overview</div>
                  <div className="flex items-center">
                    <div className="h-1 bg-gray-300 rounded w-full">
                      <div className="h-1 bg-orange-500 rounded" style={{width: '65%'}}></div>
                    </div>
                    <span className="ml-2 text-xs text-gray-500">1:25</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-xs font-medium text-gray-500">Daily Goal</div>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120" className="w-full h-auto">
          <path fill="#FFFFFF" fillOpacity="1" d="M0,96L48,85.3C96,75,192,53,288,53.3C384,53,480,75,576,80C672,85,768,75,864,64C960,53,1056,43,1152,48C1248,53,1344,75,1392,85.3L1440,96L1440,120L1392,120C1344,120,1248,120,1152,120C1056,120,960,120,864,120C768,120,672,120,576,120C480,120,384,120,288,120C192,120,96,120,48,120L0,120Z"></path>
        </svg>
      </div>
    </div>
  );
