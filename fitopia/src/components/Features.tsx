  ...
  const features = [
    {
      ...
      description:
        "Using advanced computer vision technology to detect and analyze your exercise posture in real-time, ensuring every movement is precise.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Earn experience rewards after training, level up, and unlock unique titles and trophies!",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Set personalized daily and weekly fitness goals that match your schedule. Track your workout progress with detailed statistics and visualizations.",
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">
            Experience the{" "}
            <span className="text-orange-500">Fitopia Difference</span>
          </h2>
